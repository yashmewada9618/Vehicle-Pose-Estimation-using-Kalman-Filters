...
class bag_file_reader:
    def __init__(self,bag_file):
        ...
        # self.myImu = my_bag.message_by_topic('/imu/imu_uncompensated')
        self.myGps = my_bag.message_by_topic('/gps/fix')
...
if __name__ == '__main__':
    bag_file_video = '/home/mewada/Downloads/2023-10-19-14-14-38-filtered/2023-10-19-14-14-38-filtered.bag'
